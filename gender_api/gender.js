      ...
      .then((data) => {
        ...
        if (data.gender == "female") {
          ...
          document
            ...
            .setAttribute("src", "icons8-lol-female-50.png");
        } else {
          div.classList.add("male");
          document
            .getElementById("gender-icon")
            .setAttribute("src", "icons8-user-male.svg");
        }
      });
    document.getElementById("name").value = "";
  } else {
    error.innerHTML = "Enter a valid name with no spaces and without special characters like @,-,_, etc";
  }
};
